...
class CombineChartView(private val context: Context) {

    private val TAG = javaClass.simpleName

    var dataSize = 7 //預設資料筆數

    var zeroNum = 0 // 是空的資料筆數(讓其顯示為缺席)
    ...
    /**偽造資料的部分：前後加上兩個隨機值*/
    fun forChartData(data: ArrayList<UserRecordModel.Data>, randomRange: Long): List<UserRecordModel.Data> {
...
//            println("此時要取的Y軸標籤min值是===>$min")
    ...
    fun initCombineCharView(lineChart: CombinedChart, datas: List<UserRecordModel.Data>, xLabels: Array<String>) {
...
//        )
    ...
    /**==========================產生測試資料程式碼如下==========================*/
    fun getCombineExampleData(dataSize: Int, zeroNum: Int): ArrayList<UserRecordModel.Data> {
