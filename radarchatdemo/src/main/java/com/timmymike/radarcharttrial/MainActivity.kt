...
import com.timmymike.radarcharttrial.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private var hLineNum = 7
    private var dataSize = 9
...
//                })
    ...
    private fun initRadarChatView(chart: RadarChart) {
...
//        marker = mv // Set the marker to the chart
            ...
            val useTextSize = 10f
            chart.data = setRadarChartData(chart, dataSize)  //設定圖表資料
...
//        typeface = tfLight
    ...
    private fun setRadarChartData(chart: RadarChart, dataSize: Int): RadarData {
        val mul = 160f
        val min = 40f
        ...
        val textSize = 8f
        val set1 = RadarDataSet(entries1, "Employer A").apply {
        ...
        val set2 = RadarDataSet(entries2, "Employer B").apply {
...
//            valueTextColor = textColor            // 設置Y值顏色(預設黑色)
        ...
        val set3 = RadarDataSet(entries3, "Employer C").apply {
