...
import com.timmymike.horizontalbarchartrial.databinding.DialogSettingBinding
...
//fun showMessageDialogOnlyOKButton(context: Context, message: String) {
//    TextDialog(context).apply {
//        title = message
//        binding.btnLift.visibility = View.GONE
//        binding.btnRight.text = context.getString(R.string.ok)
...
//}
//
//fun showMessageDialogOnlyOKButton(context: Context, title: String, message: String) {
//    TextDialog(context).apply {
//        this.title = title
