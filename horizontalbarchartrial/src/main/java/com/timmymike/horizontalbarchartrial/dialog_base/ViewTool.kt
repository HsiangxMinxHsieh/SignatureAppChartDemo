...
object ViewTool {
     ...
     * @return the View.OnClickListener attached to the tools.view; null if it could not be retrieved
     */
    ...
    fun getOnClickListenerV(view: View): View.OnClickListener? {
        ...
        val viewStr = "android.tools.view.View"
        val field: Field
    ...
    fun getOnClickListenerV14(view: View): View.OnClickListener? {
        var retrievedListener: View.OnClickListener? = null
        val viewStr = "android.tools.view.View"
        val lInfoStr = "android.tools.view.View\$ListenerInfo"
    ...
    //	public static View.OnTouchListener getOnTouchListener(View tools.view) {
    //	    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
    //	        return getOnTouchListenerV14(tools.view);
    //	    } else {
    //	        return getOnTouchListenerV(tools.view);
    //	    }
    //	}
